...
import groq from './pictures/groq.png';
import mobian from './pictures/themobian_logo.png';
            ...
            <div className="border3" style={{ border: mode === 'dark' ? '1px solid white' : '1px solid black' }}>
                ...
                <div className="card-container"> {}
                    ...
                    variant="outlined">
                        {card(mode, "Mobian",
                            "Software Engineer",
                            "Owned and scaled multiple ad-tech REST APIs in Go and Python (including ML services), built ETL pipelines for large-scale ad impression data, maintained/migrated PostgreSQL databases, and led client consultations.",
                            "Mar 2025 - Present",
                            mobian, 40, 40)}
                    </Card>
                    ...
                    variant="outlined">
                        {card(mode, "Groq Inc.",
                            ...
                            "Automated performance/ regression test suites and designed inference accuracy tests for ML models, including Facebook OPT, BERT Large, GoogleNet, and FFN.",
                            "Jan-Apr 2024",
                            groq, 40, 40)}
                    </Card>
